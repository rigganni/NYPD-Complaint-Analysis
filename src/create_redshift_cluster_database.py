...
def create_redshift_cluster():
    ...
    DWH_CLUSTER_SUBNET_GROUP_NAME = config.get(
        "DWH", "DWH_CLUSTER_SUBNET_GROUP_NAME")
    DWH_CLUSTER_VPC_SECURITY_GROUP_ID = config.get(
        "DWH", "DWH_CLUSTER_VPC_SECURITY_GROUP_ID")
    ...
    try:
        response = redshift.create_cluster(
            ...
            DWH_CLUSTER_SUBNET_GROUP_NAME,  # Used to place cluster in specified VPC. You must have access to said VPC (i.e. VPN, bastion host, etc.)
    ...
    myClusterLeaderNode = redshift.describe_clusters(
